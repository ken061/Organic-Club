...
function add_products(nametitle, id) {
  ...
  if (target == null) {
    ...
    var add = '<div id="cart' + namenospace + '" class="col-12 shoppingcart-items"><img src="images/'+name+'.jpeg" class="shoppingcart-pictures " alt="products"><div class="shoppingcart-desc"><h3>' + nametitle + '</h3><div class="number"><span class="minus" onclick="cartminus(this,\''+id+'\')">-</span><input id="' + namenospace + '_' + id + '" name="'+nameunderscore+'" type="text" value="' + ammount + '"><span class="plus" onclick="cartplus(this,\'' +id+ '\')">+</span></div></div><div class="remove-shoppingcart" onclick="delete_product(cart' + namenospace + ')"><i class="fa-solid fa-trash"></i></i></div></div>';
